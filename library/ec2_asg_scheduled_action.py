...
# from https://github.com/mmochan/ansible-aws-ec2-asg-scheduled-actions/blob/master/library/ec2_asg_scheduled_action.py
#
...
def main():
    ...
    try:
        ...
        region = region if not module.params.get('region') else module.params.get('region')
